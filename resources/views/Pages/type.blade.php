...
@section('meta')
    ...
    <meta property="og:image" content="https://valovov-images-container.s3.af-south-1.amazonaws.com/wallpapers/wl1.jpg" />
...
@section('content')
    <div class="lg:flex mt-16 lg:mt-28  py-2">
        ...
        <div class="content w-full">
            ...
            @livewire('type', ['searchCategory' => $searchCategory, 'attair' => $attair])
        </div>
    </div>
    <script>
