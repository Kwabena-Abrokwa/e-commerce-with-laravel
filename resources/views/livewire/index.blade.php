<div class="id">
    ...
    @endif
    <div id="popularProduct" class="my-1 xl:w-11/12 block mx-auto">
        <div class="header text-sm">
            <h5 class="text-lg xl:text-2xl font-extrabold text-center">TRENDING PRODUCTS</h5>
        </div>
        <div class="categories grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 justify-between my-1 ">
                    ...
                    <div class="modal-body ">
                        @if ($previewCount > 0)
                            @foreach ($preview as $product)
                                <div class="md:flex md:justify-around overflow-y-scroll">
                                    ...
                                    <div class="writings mt-20 md:mt-0 md:w-1/2 p-4">
    ...
    $findCartProduct->id == $product->id)
                                            ...
                                            <div class="options lg:flex justify-between">
                                                ...
                                                <div class="w-full  lg:hidden">
                                                    <a href="cart" class="btn btn-dark w-full">Go to Cart</a>
                                                </div>
                                            </div>
                                        @else
                                            <div class="line-top border-t-2"></div>
                                                    ...
                                                    <div class="color">
                                                        <select name="" id="" wire:model.lazy="productColor"
                                                            ...
                                                            @elseif ($product->category == 'Brands')
                                                                <option value="">Color</option>
                                                                <option
                                                                    value="{{ $product->product_brands->color1 }}">
                                                                    {{ $product->product_brands->color1 }}
                                                                </option>
                                                                <option
                                                                    value="{{ $product->product_brands->color2 }}">
                                                                    {{ $product->product_brands->color2 }}
                                                                </option>
                                                                <option
                                                                    value="{{ $product->product_brands->color3 }}">
                                                                    {{ $product->product_brands->color3 }}
                                                                </option>
                                                            @elseif ($product->category == 'Footwears')
                                                                <option value="">Color</option>
                                                                <option
                                                                    value="{{ $product->product_footwear->color1 }}">
                                                                    {{ $product->product_footwear->color1 }}
                                                                </option>
                                                                <option
                                                                    value="{{ $product->product_footwear->color2 }}">
                                                                    {{ $product->product_footwear->color2 }}
                                                                </option>
                                                                <option
                                                                    value="{{ $product->product_footwear->color3 }}">
                                                                    {{ $product->product_footwear->color3 }}
                                                                </option>
                                                            @elseif ($product->category == 'Thrifts')
                                                                <option value="">Color</option>
                                                                <option
                                                                    value="{{ $product->product_thrifts->color }}">
                                            ...
                                            <div class="add-to-cart my-1">
                                                ...
                                                <a href="#" class="btn btn-dark w-full mx-auto " wire:loading
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        width="36px" height="36px" viewBox="0 0 100 100"
                                                        preserveAspectRatio="xMidYMid">
                                                        <circle cx="50" cy="50" fill="none" stroke="#ffff"
                                                            stroke-width="4" r="27"
                                                            stroke-dasharray="127.23450247038662 44.411500823462205">
                                                            <animateTransform attributeName="transform" type="rotate"
                                                                repeatCount="indefinite" dur="1s"
