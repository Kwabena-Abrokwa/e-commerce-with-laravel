    ...
    <div class="w-full">
        @if ($products->count() > 0)
            @foreach ($products as $product)
                <div class="lg:flex lg:justify-around w-full mx-auto my-10">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-indicators mt-4">
                                <div data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                                    class="active " aria-current="true" aria-label="Slide 1" style="width:110px">
                                ...
                                <div type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"
                                    class='' aria-label="Slide 2" style="width:110px">
                                    @if ($product->category == 'Accessories')
                                ...
                                <div type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2"
                                    class=' h-28' aria-label="Slide 3" style="width:110px">
                                    @if ($product->category == 'Accessories')
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    @if ($product->category == 'Accessories')
                                        <img src="{{ Storage::disk('s3')->url($product->product_accessories->image1) }}"
                                            class=" w-full lg:w-5/6 mx-auto p-4" alt="{{ $product->name }}">
                                    @elseif ($product->category == 'Brands')
                                        <img src="{{ Storage::disk('s3')->url($product->product_brands->image1) }}"
                                            class="w-full lg:w-5/6 mx-auto p-4" alt="{{ $product->name }}">
                                    @elseif ($product->category == 'Cosmetics')
                    ...
                    <div class="writings mt-20 lg:mt-0 lg:w-1/2 p-4">
                        ...
                        @if (Cart::instance('shopping')->content()->count() > 0 && $findCartProduct->id == $product->id)
                        ...
                        @else
                            ...
                            @if ($product->category != 'Cosmetics')
                                <div class="message">
                                    <div class="line-top border-t-2"></div>
                                    <p class="text-md py-1">Select color to dispaly available sizes
                                    </p>
                                </div>
                                    ...
                                    <div class="color">
                                        <select name="" id="" wire:model.lazy="productColor"
                                            ...
                                            @if ($product->category == 'Accessories')
                                                ...
                                                <option value="{{ $product->product_accessories->color }}">
                                    ...
                                    <div class="size">
                                        @if ($product->category == 'Accessories')
                                            <select name="" id="" wire:model.lazy="productSize"
                                                ...
                                                <option value="{{ $product->product_accessories->size }}">
                                        ...
                                        @elseif ($product->category == 'Brands')
                                            ...
                                            @elseif ($productColor == $product->product_brands->color2)
                                                <select name="" id="" wire:model.lazy="productSize"
                                                    class="border-2 border-black shadow h-9 px-1 bg-white w-36 md:w-full text-sm">
                                                    <option value="">Size</option>
                                            ...
                                            @elseif ($productColor == $product->product_brands->color3)
                                                <select name="" id="" wire:model.lazy="productSize"
                                                    class="border-2 border-black shadow h-9 px-1 bg-white w-36 md:w-full text-sm">
                                                    <option value="">Size</option>
                                        ...
                                        @elseif ($product->category == 'Footwears')
                                            ...
                                            @elseif ($productColor == $product->product_footwear->color2)
                                                <select name="" id="" wire:model.lazy="productSize"
                                                    class="border-2 border-black shadow h-9 px-1 bg-white w-36 md:w-full text-sm">
                                                    <option value="">Size</option>
                                            ...
                                            @elseif ($productColor == $product->product_footwear->color3)
                                                <select name="" id="" wire:model.lazy="productSize"
                                                    class="border-2 border-black shadow h-9 px-1 bg-white w-36 md:w-full text-sm">
                                                    <option value="">Size</option>
                            ...
                            <div class="flex flex-row h-10 rounded-lg relative bg-white mt-1 relative">
                                <button wire:target="decrement({{ $product->id }})"
                                ...
                                <button wire:target="increment({{ $product->id }})"
                                ...
                                <div class="w-full mx-auto absolute z-50 bg-white h-10" wire:loading
                                    wire:target="increment({{ $product->id }})">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        style="margin: auto; background: #ffffffbb; display: block; shape-rendering: auto;"
                                        width="36px" height="36px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                                        <circle cx="50" cy="50" fill="none" stroke="#000" stroke-width="4" r="27"
                        ...
                        <ul class="nav nav-tabs mt-8" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">Size Guide</button>
                            </li>
                        </ul>
