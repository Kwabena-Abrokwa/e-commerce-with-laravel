...
class Filter extends Component
{
    ...
    public function render()
    {
        return view('livewire.filter', [
            'products' => Products::where('category', 'like', $this->searchCategory)->where('type', 'like', $this->gender)
