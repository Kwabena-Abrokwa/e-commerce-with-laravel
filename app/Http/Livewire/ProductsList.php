...
class ProductsList extends Component
{
    ...
    public function mount($id, $referral)
    {
    ...
    public function addToCart($id)
    {
        ...
        switch ($products->category) {
            case 'Accessories':
                if ($this->referral == 0) {
                    $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_accessories->image1, 'category' => $products->category, 'destination_fee' => 20]);
                } else {
                    $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_accessories->image1, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                }
                break;
            case 'Brands':
                switch ($this->productColor) {
                    case $products->product_brands->color1:
                        if ($this->referral == 0) {
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_brands->image1, 'category' => $products->category, 'destination_fee' => 20]);
                        } else {
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_brands->image1, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                        }
                        break;
                    case $products->product_brands->color2:
                        if ($this->referral == 0) {
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_brands->image2, 'category' => $products->category, 'destination_fee' => 20]);
                        } else {
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_brands->image2, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                        }
                        break;
                    case $products->product_brands->color3:
                        if ($this->referral == 0) {
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_brands->image3, 'category' => $products->category, 'destination_fee' => 20]);
                        } else {
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_brands->image3, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                        }
                        break;
                    default:
                        return false;
            ...
            case 'Cosmetics':
                if ($this->referral == 0) {
                    $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_cosmetics->image1, 'category' => $products->category, 'destination_fee' => 20]);
                } else {
                    $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_cosmetics->image1, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                }
                break;
            case 'Footwears':
                switch ($this->productColor) {
                    case $products->product_footwear->color1:
                        if ($this->referral == 0) {
                        $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_footwear->image1, 'category' => $products->category, 'destination_fee' => 20]);
                    }else{
                        $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_footwear->image1, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                    }
                        break;
                    case $products->product_footwear->color2:
                        if ($this->referral == 0) {
                        $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_footwear->image2, 'category' => $products->category, 'destination_fee' => 20]);
                        }else{
                        $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_footwear->image2, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                        }
                        break;
                    case $products->product_footwear->color3:
                        if ($this->referral == 0) {
                        $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_footwear->image3, 'category' => $products->category, 'destination_fee' => 20]);
                        }else{
                            $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_footwear->image3, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                        }
                        break;
                    default:
                        return false;
            ...
            case 'Thrifts':
                if ($this->referral == 0) {
                $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_thrifts->image1, 'category' => $products->category, 'destination_fee' => 20]);
                }else{
                    $added = Cart::instance('shopping')->add($products->id, $products->name, $this->quantity, $products->price, ['color' => $this->productColor, 'size' => $this->productSize, 'merchant_id' => $products->merchant_users_id, 'checkout_id' => 1, 'img' => $products->product_thrifts->image1, 'category' => $products->category, 'destination_fee' => 20, 'referral' => $this->referral]);
                }
                break;
            default:
                return false;
    ...
    public function render()
    {
        return view('livewire.products-list', [
            'products' => Products::where('id', $this->identity)
