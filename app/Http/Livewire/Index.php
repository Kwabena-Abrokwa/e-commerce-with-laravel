...
class Index extends Component
{
    ...
    {
        $this->products = Cache::remember('product-home-new', 100, function() {
          return  Products::with('product_accessories', 'product_thrifts', 'product_brands', 'product_cosmetics', 'product_footwear')->where('total_quantity', '>', 0)->get()->random(1);
       });
    }
    ...
    public function productPreview($id)
    {
        ...
        $this->preview = Products::where('id', '=', $id)->get();
